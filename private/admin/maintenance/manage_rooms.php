...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Create New " ?> Rooms</h3>
	</div>
	<div class="card-body">
		<form action="" id="rooms-form">
			<input type="hidden" name ="id" value="<?php echo isset($id) ? $id : '' ?>">
			<div class="form-group">
				<label for="name" class="control-label">Room's Name</label>
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" form="rooms-form">Save</button>
		<a class="btn btn-flat btn-default" href="?page=maintenance/rooms">Cancel</a>
	</div>
</div>
<script>
			...
			$.ajax({
				...
				success:function(resp){
					if(typeof resp =='object' && resp.status == 'success'){
						location.href = "./?page=maintenance/rooms";
