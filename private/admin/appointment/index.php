        ...
        <div class="container-fluid">
			<table class="table table-bordered table-hover table-striped">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT r.*, t.sched_type, brgy.brgyDesc, city.citymunDesc, prov.provDesc from `appointment_request` r inner join `schedule_type` t on r.sched_type_id = t.id left join
...
<script>
	$(document).ready(function(){
		...
		$('.print_data').click(function(){
			window.open("appointment/print.php?id="+$(this).attr('data-id'),"_blank");
		})
