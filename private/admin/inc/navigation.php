...
<!-- Main Sidebar Container -->
 ...
 <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=room_request" class="nav-link nav-room_request">
                        <i class="nav-icon fas fa-calendar-check"></i>
                        <p>
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=maintenance/rooms" class="nav-link nav-rooms">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=admin/list" class="nav-link nav-admin/list">
