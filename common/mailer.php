...
function generateProfessionalAccountConfirmation(){
    $body = '<div style="margin:0;padding:0" bgcolor="#FFFFFF">
                <table width="100%" height="100%" style="min-width:348px" border="0" cellspacing="0" cellpadding="0" lang="en">
                    <tbody>
                        <tr height="32" style="height:32px">
...
if(isset($_POST["action"]) and $_POST["action"] == 'send-account-confirmation'){
    $email = $_POST["email"];
    //$email = 'dev.jomar217@gmail.com';//$_POST["email"];
    ...
    try {
        ...
        $mail->addAddress($email);
        $mail->isHTML(true);
        $mail->Subject = '[Code Connect] Professional Account Approved';
        $mail->Body = generateProfessionalAccountConfirmation();
        $mail->send();
